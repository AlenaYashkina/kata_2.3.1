...
public class PersistenceJPAConfig{
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.hbm2ddl.auto", environment.getProperty("db.ddl-auto"));
        properties.setProperty("hibernate.dialect", environment.getProperty("db.dialect"));
        properties.setProperty("hibernate.show-sql", environment.getProperty("db.show-sql"));
